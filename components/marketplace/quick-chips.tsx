    ...
    <div className="flex items-center gap-3 border-b border-white/30 px-3 py-3 md:flex-wrap md:justify-between md:px-6">
      {onOpenFilters && (
        <button
          ...
          className="inline-flex flex-shrink-0 items-center gap-1.5 rounded-full border border-white/40 bg-white/50 px-3 py-1.5 text-xs font-medium text-foreground/80 transition-colors hover:text-foreground md:hidden"
        >
