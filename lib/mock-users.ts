...
export type MockUser = {
  ...
  countries: number;
  bondedVava: number;
  /** ISO codes this user is the sitting president of (top bonder in-country).
   * Mock today; computed from on-chain bonding when the indexer ships. */
  presidentOf?: string[];
};

export const MOCK_USERS: ReadonlyArray<MockUser> = [
  { addr: '0xA4B2…82F1', username: 'vavaqueen',  country: 'se', joined: '2025-09-12', hexes: 1842, countries: 31, bondedVava: 2_410_000, presidentOf: ['se'] },
  ...
  { addr: '0xDEAD…BEEF', username: 'whale',      country: 'kr', joined: '2025-08-04', hexes: 3204, countries: 47, bondedVava: 4_120_000, presidentOf: ['kr', 'jp'] },
