...
const RULES: Rule[] = [
  {
    ...
    title: 'Every tile is loaded.',
    body: 'Claim a tile and 15% of what you paid buys $VAVA and locks it inside. Your land is not a deed — it carries treasure.',
  ...
  },
  {
    ...
    figure: '0',
    tone: '',
    unit: 'tiles can sell below floor',
    title: 'Your land has a floor.',
    body: 'Raze a tile whenever you like and walk away with the $VAVA inside it. That makes a tile impossible to sell for less than it holds.',
  ...
  },
  {
    ...
    figure: '1.66T',
    tone: '',
    unit: 'tiles still unclaimed',
    title: 'The map only shrinks.',
    body: 'A claimed tile never returns to the pool. Every claim makes open ground rarer, and the price of that country climbs.',
