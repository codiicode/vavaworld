/**
 * ISO 3166-1 alpha-2 country codes + names. Sourced from the official ISO list.
 * Used by the country flag picker on the profile edit dialog.
 */
...
export function findCountry(code: string | null | undefined): Country | null {
  if (!code) return null;
  return _byCode.get(code.toLowerCase()) ?? null;
}
