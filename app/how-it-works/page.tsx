...
const STEPS = [
  ...
  },
  {
    n: 'ii.',
    title: 'Claim it.',
    body: 'Pay with ETH or USDG straight from your wallet - every nation starts at $0.10 per hex, and each claim nudges only that nation&apos;s price up. First come, first served.',
  },
  {
    n: 'iii.',
    title: "It's yours.",
