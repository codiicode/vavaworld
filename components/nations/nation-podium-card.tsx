...
const VARIANT = {
  ...
  silver: {
    ...
    shadow:
      '0 14px 40px -16px rgba(0,0,0,0.8), inset 0 1px 0 rgba(255,255,255,0.08)',
    label: '2nd',
  ...
  bronze: {
    ...
    shadow:
      '0 10px 30px -14px rgba(0,0,0,0.8), inset 0 1px 0 rgba(255,255,255,0.08)',
    label: '3rd',
    labelColor: 'text-white/85',
  ...
  return (
    ...
    >
      ...
      <div className="mb-2.5 flex items-center justify-between">
        ...
        {isGold && <Crown size={15} strokeWidth={1.8} className="text-white/70" />}
